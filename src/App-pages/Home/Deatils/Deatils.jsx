        ...
        <div className="grid grid-flow-row  gap-4   " >
            ...
            <div className="text-start  rounded-lg bg-white shadow-2xl p-4 items-center text-[16] " >
                ...
                <div className="text-end py-4">
                    <h1 > وَحْدَهُ لَا شَرِيْكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، اَللَّهُمَّ لَا مَانِعَ لِمَا أَعْط</h1>
                    <h2 className="pt-4"> مُعْطِيَ لِمَا مَنَعْتَ وَلَا يَنْفَعُ ذَا الْجَدِّ مِنْكَ الْجَدُّ</h2>
                </div>
                <div className="py-4 text-justify ">
                    <h2 className="pb-2" ><span className=" font-bold ">Transliteration: </span> Laa ilaaha illallahu wahdahu laa sharika lahu, lahul-mulku wa lahul-hamdu wa huwa 'alaa kulli shay'in qadir. Allaahumma laa maani'a limaa a'taita wa laa mu'tia limaa mana'ta wa laa yanfa'u dhal-jaddi minka al-jaddu</h2>
                    <h3> <span className="font-bold ">Translation:F </span> There is none worthy of worship except Allah alone with no partner or associate. He is the Dominion and to Him be all praise, and He is able to do all things. O Allah, one can withhold what You have given and none can give what You have withheld, and no wealth or fortune can benefit anyone for from You comes all wealth and fortune.</h3>
                </div>
                <p className=" text-[#1FA45B]">Reference :</p>
                <p className="pb-6">Surah Al-Fatir 35-15</p>
                <div className="  flex gap-6 justify-end  ">
